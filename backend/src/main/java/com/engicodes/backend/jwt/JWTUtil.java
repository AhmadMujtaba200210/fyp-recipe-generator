...
public class JWTUtil {
    ...
    public boolean isTokenValid(String token, UserDetails userDetails) throws ResourceNotAuthorisedException {
        final String username = extractUsername(token);
        isValid=(username.equals(userDetails.getUsername())) && !isTokenExpired(token);
        if (isValid) return true;
        else throw new ResourceNotAuthorisedException("Resource Not Authorised!");
    }
